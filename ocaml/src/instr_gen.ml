...
(*** Nop ***)
(** nop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Drop ***)
(** drop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Select ***)
(** select_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
and select_gen con t_opt size = match t_opt with
  | Some t -> Gen.(return (Some (Helper.as_phrase (Ast.Select), [Types.I32Type; t; t])))
...
(** unop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(** binop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Test operations ***)
(** testop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(** relop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Convert operations ***)
(** int32Op_cvtop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
and int32Op_cvtop_gen = Gen.oneofl
...
(** int64Op_cvtop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
and int64Op_cvtop_gen = Gen.oneofl
...
(** float32Op_cvtop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
and float32Op_cvtop_gen = Gen.oneofl
...
(** float64Op_cvtop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
and float64Op_cvtop_gen = Gen.oneofl
...
(** cvtop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Block ***)
(** block_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** Loop ***)
(** loop_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
...
(*** If ***)
(** if_gen : context_ -> value_type option -> int -> (instr * value_type list) option Gen.t **)
